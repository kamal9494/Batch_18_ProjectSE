	...
	<div class="container-down">
			...
			?>
				<div class="card" style="width: 18rem;margin: 15px 10px">
					...
					<div> <img class="card-img-top" src="<?php echo basename('uploads/') . "/" .  $row['product_image']; ?>" width="200" height="200"> </div>
					<div class="card-body"> <h5 class="card-title"><?php echo $row['productname'] ?> </h5>
						<p class="card-text" style="color: crimson"><strong><?php echo "&#8377;" . $row['price'] ?></strong> </p>
						<p><a href="removefromcart.php?del=<?php echo $row['cart_id'] ?>"><button class="btn btn-primary" > Remove from Cart</button></a></p>
					</div>
...
<div class="floaty">
		...
		<h3 align="center">Total Cost = &#8377;  <?php echo $totalCost ."</h3>" ?>
		<br>
		<p align="center"><a href="checkout.php"><button class="btn btn-success">Continue to Checkout</button></a></p>
		</div>
		<br>
