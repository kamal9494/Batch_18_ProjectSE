...
<body>
    ...
    <form style="margin:45px" action="placeOrder.php" method="post">
        ...
        <div style="margin:15px; width:30%" class="form-group">
            <label for="exampleFormControlTextarea1">Enter Address</label>
            <textarea name="address" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
        </div>

        <div>
            <button style="margin:0 15px" name="pay" type="submit" class="btn btn-success">PAY &#8377; <?php echo $totalCost ?> </button>
        </div>
    </form>
