...
echo '<a href="register.php" target="_self"><button class="btn btn-primary">Create Account</button></a>';
echo "<br>";
echo "<br>";
	}
	?>
<a href="categories.php" target="_self"><button class="btn btn-primary">Browse our Collection</button></a>
</div>
</center>
